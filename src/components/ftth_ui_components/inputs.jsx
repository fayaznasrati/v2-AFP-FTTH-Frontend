...
export const SearchInputElement = ({
  ...
  hint,
  icon,
  iconHeight = "h-6", // default height
  iconWidth = "w-6", // default width
}) => {
  ...
  return (
    <div className="relative">
      ...
      {icon && (
        <span
          className={`absolute top-1/2 right-0 w-[50px] hover:bg-primary1 text-primary1 hover:text-white cursor-pointer transition-all duration-300 rounded-r-md transform bg-primary2 h-full  -translate-y-1/2 flex items-center justify-center ${iconHeight} ${iconWidth}`}
        >
